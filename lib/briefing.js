...
All implementation plans MUST end with a **Verify & Signal** step. A plan without one is incomplete. Example final step:

  N. **Verify & Signal** — run \`prove_it signal done -m "<what changed>"\``
