...
const VALID_WHEN_KEYS = ['fileExists', 'envSet', 'envNotSet', 'variablesPresent', 'linesWrittenSinceLastRun', 'sourcesModifiedSinceLastRun']

const KNOWN_TOP_LEVEL_KEYS = [
  'configVersion', 'enabled', 'sources', 'format', 'hooks', 'runs', 'initSeed'
]
