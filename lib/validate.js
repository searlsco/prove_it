...
const KNOWN_TOP_LEVEL_KEYS = [
  'enabled', 'sources', 'format', 'taskEnv', 'taskAllowedTools', 'taskBypassPermissions', 'hooks', 'runs', 'initSeed', 'fileEditingTools', 'model', 'ignoredPaths'
]
const KNOWN_HOOK_KEYS = [
  'type', 'event', 'tasks', 'matcher', 'triggers', 'source'
]
const KNOWN_TASK_KEYS = [
  'name', 'type', 'command', 'prompt', 'promptType', 'when', 'timeout', 'model', 'ruleFile', 'enabled', 'resetOnFail', 'quiet', 'async', 'parallel', 'params'
]
