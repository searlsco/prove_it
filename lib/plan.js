...
/**
 * Build the phase implementation block injected after the plan title.
 */
function buildPhaseBlock () {
  return `## Enter implementation phase

Before making any edits, transition prove_it into implementation mode.
This allows file writes and enables test-edit cycle tracking as you work.
