...
const { backchannelDir, backchannelReadmePath } = require('../paths')
const { readBackchannel, cleanBackchannel } = require('./agent')
const { extractAppealText } = require('../monitor')
const reviewer = require('../reviewer')
const { SESSION_KEYS, saveSessionState, loadSessionState, logReview } = require('../session')
...
SKIP—suspend the task (benefit of the doubt / unclear situation)`
  ...
  const review = reviewer.runReviewer(rootDir, reviewerCfg, prompt)
