...
and pure removals (deleted code, removed features, dropped exports) — if the removed
code was still needed, existing tests will fail; a new test for an absence is not useful.
