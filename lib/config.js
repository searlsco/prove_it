    ...
    hooks: [
      {
        ...
        event: 'SessionStart',
        tasks: [
          { name: 'session-briefing', type: 'script', command: 'prove_it run_builtin session:briefing', quiet: true }
        ]
      },
      {
        type: 'claude',
      ...
      },
      {
        ...
        event: 'Stop',
        tasks: [
          { name: 'fast-tests', type: 'script', command: './script/test_fast', when: { sourcesModifiedSinceLastRun: true } },
          { name: 'full-tests', type: 'script', command: './script/test', when: { signal: 'done', sourceFilesEdited: true } }
        ]
      }
    ]
  }
 ...
 * @param {boolean} options.defaultChecks - Include prove-coverage, prove-shipworthy (default: true)
