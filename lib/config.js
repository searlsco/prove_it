 ...
 * @param {boolean} options.gitHooks - Include git pre-commit/pre-push hooks (default: true)
 * @param {boolean} options.defaultChecks - Include beads-gate, code-review, coverage-review (default: true)
