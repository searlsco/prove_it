...
const { SIGNAL_PLAN_MARKER, SIGNAL_TASK_PATTERN, detectLastNumberedHeading, buildSignalBlock, findPlanFile, appendPlanBlock } = require('../plan')
...
async function dispatch (event) {
  ...
  if (hookEvent === 'PreToolUse' && toolName === 'ExitPlanMode') {
    injectSignalBlock(input.tool_input, hasSignalGatedTasks(hooks))
