...
const { logReview, getAsyncDir, recordFileEdit, getFileEdits, resetTurnTracking, saveSessionState, VALID_SIGNALS, setSignal, getSignal, clearSignal } = require('../session')
...
const PREREQUISITE_KEYS = ['fileExists', 'envSet', 'envNotSet', 'variablesPresent', 'signal']
